...
#    file_name : bpy.props.StringProperty(name = "File Path")
    ...
    frame_start : bpy.props.IntProperty(name = "Frame Start", min = bpy.data.scenes[0].frame_start, max = bpy.data.scenes[0].frame_end, default = bpy.data.scenes[0].frame_start)
    frame_end : bpy.props.IntProperty(name = "Frame End", min = bpy.data.scenes[0].frame_start, max = bpy.data.scenes[0].frame_end, default = bpy.data.scenes[0].frame_end)
